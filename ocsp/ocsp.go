...
// TODO(sclark): This is also from crypto/x509, so same comment as AGL's below
...
// TODO(sclark): this is taken from crypto/x509 and should probably be exported
...
func CreateResponse(issuer, responderCert *x509.Certificate, template Response, priv crypto.Signer) ([]byte, error) {
	...
	hashFunc, pkixSignatureAlgorithm, err := signingParamsForPublicKey(priv.Public(), template.SignatureAlgorithm)
	if err != nil {
		return nil, err
	}
